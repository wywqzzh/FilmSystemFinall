...
<html>
  <head>
    <title>$Title$</title>
    <base href="<%=basePath%>">
    <link rel="stylesheet" href="<%=basePath%>/css/hotshow.css">
  </head>
  <body>
    <div class="top">
      <h1 class="logo" >
                 ...
                 for(int i=0;i<films.size();i++){%>
                    <li>
                      <ul >
                        ...
                        <li class="li3"><a>评分:<%=films.get(i).getFilmRating()%></a></li>
                        <li class="li4"><a class="myButton" href="filmAction/buyTicket?filmId=<%=films.get(i).getFilmId()%>">购票</a></li>
                      </ul>
                  </li>
              <%}}%>
            </ul>
